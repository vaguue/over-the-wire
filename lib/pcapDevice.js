...
class PcapDevice extends Duplex {
  constructor(options) {
    ...
    this.pcapInternal = new PcapDeviceStream(this.options);
  }
  ...
  _write(chunk, encoding, callback) {
    return this._writeImpl(chunk, callback);
  }

  _writev(chunks, callback) {
    return this._writeImpl(chunks.map(e => e.chunk).flat(), callback);
  }

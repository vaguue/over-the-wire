...
addr.port = 123;
console.log(addr.toBuffer(), addr.toString(), addr);
//console.log('and here', socket.inetNtop(2, socket.inetPton(2, '192.168.1.1')));
console.log('here', socket.inetNtop(socket.inetPton('192.168.1.1')));
console.log('and here', socket.inetPton('192.168.1.1'));

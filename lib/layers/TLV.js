...
function TLVSerialize(Cls, PaddingCls, opts, align = null, { skipTypes = [], lengthIsTotal = false } = {}) {
  let res = Buffer
    .concat(opts
      .map(e => skipTypes.includes(e.type) ? 
        new PaddingCls(e, { skipTypes, lengthIsTotal }).buffer : 
        new Cls(e, { skipTypes, lengthIsTotal }).buffer
      )
    );
...
module.exports = { TLV_8, TLVPadding_8, TLVIterator, TLVSerialize };

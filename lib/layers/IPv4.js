...
const childProto = {
  [IPProtocolTypes.UDP]: layers => layers.UDP,
  [IPProtocolTypes.TCP]: layers => layers.TCP,
  [IPProtocolTypes.ICMP]: layers => layers.ICMP,
  [IPProtocolTypes.GRE]: layers => layers.GRE,
  [IPProtocolTypes.IGMP]: layers => layers.IGMP,
  [IPProtocolTypes.AH]: layers => layers.AuthenticationHeader,
  [IPProtocolTypes.ESP]: layers => layers.ESP,
  [IPProtocolTypes.IPV6]: layers => layers.IPv6,
  [IPProtocolTypes.VRRP]: layers => layers.VRRP,
};

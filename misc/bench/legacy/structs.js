...
function initPcapNG() {
   ...
   * Options in the IDB.
   */
  res.constants.OPT_IF_NAME = 2;  /* interface name string */
  res.constants.OPT_IF_DESCRIPTION = 3;  /* interface description string */
  res.constants.OPT_IF_IPV4ADDR = 4;  /* interface's IPv4 address and netmask */
  res.constants.OPT_IF_IPV6ADDR = 5;  /* interface's IPv6 address and prefix length */
  res.constants.OPT_IF_MACADDR = 6;  /* interface's MAC address */
  res.constants.OPT_IF_EUIADDR = 7;  /* interface's EUI address */
  res.constants.OPT_IF_SPEED = 8;  /* interface's speed, in bits/s */
  res.constants.OPT_IF_TSRESOL = 9;  /* interface's time stamp resolution */
  res.constants.OPT_IF_TZONE = 10;  /* interface's time zone */
  res.constants.OPT_IF_FILTER = 11;  /* filter used when capturing on interface */
  res.constants.OPT_IF_OS = 12;  /* string OS on which capture on this interface was done */
  res.constants.OPT_IF_FCSLEN = 13;  /* FCS length for this interface */
  res.constants.OPT_IF_TSOFFSET = 14;  /* time stamp offset for this interface */
